...
const S = {
  ...
  btnEnv:   { background: "rgba(93,226,255,.09)", border: `1px solid ${C.azul}`, borderRadius: 8, color: C.azul, padding: "0 16px", fontSize: 16, cursor: "pointer", flexShrink: 0, opacity: 1 },
